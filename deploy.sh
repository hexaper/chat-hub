...
#
# Installs all system dependencies, configures Redis, Nginx,
...
echo "[2/7] Setting up application user..."
...
# ── 5. Redis & Django setup ──────────────────────────────────────────────────
echo "[5/7] Configuring Redis & Django..."
...
# ── 6. Systemd service (Daphne ASGI server) ─────────────────────────────────
...
echo "  Database:          $APP_DIR/db.sqlite3"
echo ""
echo "  ─── Next steps ───"
